...
func main() {
	...
	var urls = flag.String("s", "nats://nats_a:4222", "The NATS server URLs (separated by comma")
	var tls = flag.Bool("tls", false, "Use TLS secure sonnection")
	var numPubs = flag.Int("np", 1, "Number of concurrent publishers")
	var numSubs = flag.Int("ns", 1, "Number of concurrent subscribers")
